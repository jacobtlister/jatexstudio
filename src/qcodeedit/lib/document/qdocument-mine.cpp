...
bool QDocumentCursorHandle::movePosition(int count, int op, const QDocumentCursor::MoveMode& m)
{
	...
	switch ( op )
	{
		...
		case QDocumentCursor::PreviousCharacter :
		{
            ...
            // if you are moving one character left/right while a selection is active and you are not keeping the
            // selection alive, move the cursor to the side of the selection corresponding to the intended direction
